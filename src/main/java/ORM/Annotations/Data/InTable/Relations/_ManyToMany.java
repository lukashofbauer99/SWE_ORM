...
@Data
public class _ManyToMany implements _IRelationalColumn {

    private final Class annotationClass = ManyToMany.class;
    private String name;
    ...
    public void init(Field f, IConverter converter, ORM orm) throws Exception {
        ManyToMany columnAnnotation = f.getAnnotation(ManyToMany.class);
